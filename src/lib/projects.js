export const projects = [
  ...
  },
  {
    title: "Netflix clone",
    description:
      "Netflix clone built with React, Redux, Firebase, Stripe, and Sass.",
    image: "https://i.ibb.co/7QpKsCX/ecommerce.png",
    technologies: ["React", "Firebase", "Stripe", "Tailwind"],
    image: "/netflix/home-netflix.png",
    imgproject: [
  ...
  },
  {
    title: "Omnifood",
    description:
      "Omnifood est un service de livraison de repas haut de gamme dont la mission est d'apporter des repas abordables et sains au plus grand nombre de personnes possible.",
    technologies: ["Sass", "html", "css"],
    image: "/omnifood/home-omnifood.png",
    imgproject: [
      "/omnifood/mozaic-omnifood.png",
      "/omnifood/recipe-omnifood.png",
