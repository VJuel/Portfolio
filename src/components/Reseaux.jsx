...
export default function Reseaux() {
  ...
  return (
    <>
      <div className="animate-fade-in-right reseaux hidden mr-auto sm:flex flex-col justify-center items-start w-fit fixed md:top[10%] lg:top-[25%] left-[2%] [&>a]:before:hidden rounded-full shadow-lg px-2 py-4 bg-foreground [&>*]:transition-all z-40">
        <Link
