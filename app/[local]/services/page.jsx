  ...
  return (
    <div id="services" className="w-full h-auto max-w-6xl m-auto set-page">
      <div className="w-full flex m-auto flex-col px-4 justify-center items-center">
        ...
        <section className="w-full space-y-8 md:space-y-18 lg:space-y-28 bg-background margin-section">
          <h2
            className={clsx(
              robotoSlab.className,
              "text-center text-lg font-medium mb-10 lg:mb-14"
            )}
          >
            {t("formule.title")}
          </h2>
          <article className="w-full">
            <div className="flex flex-col lg:flex-row justify-center items-center m-auto w-full px-4">
              <div className="flex lg:order-2 flex-col justify-center w-full lg:w-1/2 pl-0 lg:pl-14 mb-8 lg:mb-0 p-0">
                ...
                <h3>{t("formule.vitrine.description")}</h3>
          ...
          <article className="w-full">
            <div className="flex flex-col lg:flex-row justify-center items-center m-auto w-full px-4">
              <div className="flex flex-col justify-center items-start w-full lg:w-1/2 pr-0 lg:pr-14 mb-8 lg:mb-0 p-0">
                ...
                <h3>{t("formule.ecommerce.description")}</h3>
          ...
          <article className="w-full">
            <div className="flex flex-col lg:flex-row justify-center items-center m-auto w-full px-4">
              <div className="flex order-1 lg:order-2 flex-col justify-center w-full lg:w-1/2 pr-0 pl-0 lg:pl-14 mb-8 lg:mb-0 p-0">
                ...
                <h3>{t("formule.surmesure.description")}</h3>
          ...
          <div className="flex flex-col flex-wrap md:flex-row gap-6 lg:gap-10 h-auto xlg:h-[500px] px-2 justify-center items-center">
            ...
            <Card className="w-full md:w-[350px] md:h-[500px] h-full overflow-hidden flex flex-col">
              ...
              <CardFooter className="flex justify-between flex-col items-start flex-grow-1">
                <span>
                  {t("apartir")} <strong className="text-lg">1000 €</strong>
                </span>
              </CardFooter>
            </Card>
            ...
            <Card className="w-full md:w-[350px] md:h-[500px] h-full overflow-hidden flex flex-col">
              ...
              <CardFooter className="flex justify-between flex-col items-start">
                <span>
                  {t("apartir")} <strong className="text-lg">2500 €</strong>
                </span>
              </CardFooter>
            </Card>
            ...
            <Card className="w-full md:w-[350px] md:h-[500px] h-full overflow-hidden flex flex-col">
              <CardHeader className="bg-warning">
                <CardTitle>{t("card.surmesure.description")}</CardTitle>
                <CardDescription className="text-primary">
              ...
              <CardFooter className="flex-grow flex justify-between flex-1">
                <span>
                  <strong className="text-lg">{t("devis")}</strong>
                </span>
              </CardFooter>
            </Card>
          </div>
          <div className="flex justify-center items-center lg:justify-end lg:items-end w-[90%]">
            <h3 className="italic text text-right mt-4">*{t("gratuit")}</h3>
          </div>
        </section>
      </div>
    </div>
