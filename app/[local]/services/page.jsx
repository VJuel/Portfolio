...
export default async function Services(params) {
  ...
  return (
    <div id="services" className="w-full h-auto pb-8">
      <div className="py-6">
        <div className="w-full max-w-6xl flex m-auto flex-col p-4 md:p-10 justify-center items-center w-full">
          <h1 className={clsx(robotoSlab.className, "text-3xl font-bold mb-8")}>
            Services
          </h1>

          <section className="mt-10 flex flex-col lg:flex-row justify-center items-center gap-10 h-[500px] px-4">
            {/* Card Vitrine */}
            <Card className="w-[350px] h-full overflow-hidden flex flex-col">
          ...
          <article className="w-full bg-background py-14 my-14">
            <h3
              className={clsx(
                robotoSlab.className,
                "text-center text-2xl mb-8"
              )}
            >
              Les differents services
            </h3>
            <div className="flex flex-col md:flex-row justify-center items-center max-w-6xl m-auto w-full px-4">
              <div className="flex order-2 flex-col justify-center w-full md:w-1/2 pl-0 md:pl-14 mb-8 md:mb-0 p-4">
                <h2
                  className={clsx(
                    robotoSlab.className,
                ...
                <p>
                  ...
                  offrons un design responsive, une optimisation SEO de pointe,
                  une intégration fluide des réseaux sociaux, et un système de
                  gestion de contenu intuitif pour une mise à jour facile de
                  votre site.
                </p>
              </div>
              <div className="flex order-1 flex-col justify-center bg-background rounded-sm h-full w-[45%]">
                <Image
          ...
          <article className="w-full bg-background py-14">
            <div className="flex flex-col md:flex-row justify-center items-center max-w-6xl m-auto w-full px-4">
              <div className="flex flex-col justify-center w-full md:w-1/2 pr-0 md:pr-14 mb-8 md:mb-0 p-4">
                <h2
                  className={clsx(
                    robotoSlab.className,
                    "text-xl mb-2 font-bold"
                ...
                <p>
                  ...
                  vos produits et services en ligne avec efficacité et sécurité.
                  Profitez d'une gestion intuitive de vos produits, de processus
                  de paiement sécurisés, d'expériences d'achat personnalisées,
                  d'outils de marketing intégrés, et d'analyses en temps réel
                  pour booster vos ventes.
                </p>
              </div>
              <div className="flex flex-col justify-center bg-background rounded-sm h-full w-[45%]">
                <Image
          ...
          <article className="w-full bg-background py-14">
            <div className="flex flex-col md:flex-row justify-center items-center max-w-6xl m-auto w-full px-4">
              <div className="flex order-2 flex-col justify-center w-full md:w-1/2 pr-0 pl-0 md:pl-14 mb-8 md:mb-0 p-4">
                <h2
                  className={clsx(
                    robotoSlab.className,
                    "text-xl mb-2 font-bold"
                ...
                <p>
                  Chaque entreprise est unique, et votre site web devrait l'être
                  aussi. Notre service de site personnalisé se concentre sur la
                  création de concepts de design créatifs, l'intégration de
                  fonctionnalités avancées et interactives, une stratégie SEO
                  complète, et une expérience utilisateur personnalisée pour
          ...
          <section className="flex flex-col justify-center items-center mt-10">
            <h2 className="text-center text-lg font-medium mb-6 md:mb-10">
              Pourquoi Choisir Vicktor Web Solution pour Votre Projet de Site
              Web ?
            </h2>
            <div className="flex justify-center items-center flex-col lg:flex-row gap-4 md:gap-8">
              <IconCard
                title="Responsive"
                icon={responsive}
          ...
          <p className="underline text-sm">Pour qui ?</p>
